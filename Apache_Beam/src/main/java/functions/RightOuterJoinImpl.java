...
public class RightOuterJoinImpl {
	...
	public static void main(String[] args) 
	{
		...
		output.apply(TextIO.write().to("E:\\Spring_Microservices\\Apache Beam Practicals\\right_join_example_output.csv").withNumShards(1).withSuffix(".csv"));
