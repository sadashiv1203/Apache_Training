...
import beam.sql.SQLExample.RowToString;
import beam.sql.SQLExample.StringToRow;
...
public class GroupByExample {
	...
	public static void main(String[] args) {
		...
		PCollection<Row> sqlInput=pRowInput.apply(SqlTransform.query("select userId,count(orderId) from PCOLLECTION group by userId"));
